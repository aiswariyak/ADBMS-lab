...
use Company;
create table regions(region_id int not null,region_name varchar(100) not null,primary key(region_id));
create table countries(country_id varchar(20) not null,country_name varchar(100) not null,region_id int not null,primary key(country_id),foreign key(region_id) references regions(region_id));
create table locations(location_id int not null,street_address varchar(100) not null,postal_code varchar(40),city varchar(50),state_province varchar(100),country_id varchar(100),primary key(location_id),foreign key(country_id) references countries(country_id));
create table jobs(job_id int not null ,job_title varchar(50)not null,min_salary float not null,max_salary float not null,primary key(job_id));
create table departments(department_id int not null,department_name varchar(69),location_id int not null,primary key(department_id),foreign key(location_id) references locations(location_id));
create table employees(employee_id int not null ,first_name varchar(70) not null,last_name varchar(50) not null,email varchar(100) not null,phone_number varchar(70) not null,hire_date date not null,job_id int not null,salary float not null,manager_id int ,department_id int,primary key(employee_id),foreign key(department_id) references departments(department_id),foreign key(job_id) references jobs(job_id));
create table dependents(dependent_id int,first_name varchar(100),last_name varchar(50),relationship varchar(50),employee_id int not null,primary key(dependent_id),foreign key(employee_id) references employees(employee_id));
...
use company;
alter table employees modify phone_number varchar(100) null;
describe employees;
INSERT INTO  
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES  
...
describe employees;
alter table employees add commision int;
describe employees;
select * from employees;